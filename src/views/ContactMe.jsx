		...
		<div className="flex w-full px-10 pt-10 space-x-14">
			...
			<div className="lex flex-col w-[30%] space-y-5 items-start pt-10">
				...
				<p className="text-md text-justify">
					Reach Out Today And I'll Provide You With My Comprehensive Onboarding Package Designed For Full-Time Employment Or
					Contract Based Jobs. This Package Covers Various Aspects That Potential Employers Often Inquire About, Such As My
					Salary Expectations And The Seamless Integration Process Into Your Company.
				</p>
			</div>
		</div>
	);
