...
const Portfolio = () => {
	const technologies = {
		title: "Technologies",
		description:
			"Experienced in web development using React & Node.js. Proficient in integrating blockchain with traditional payment systems for a seamless web item.",
		list: [
			{
		...
		<Transition appear={true} show={true} enter="transition-opacity duration-500" enterFrom="opacity-0" enterTo="opacity-100">
				...
				<div className="grid gap-4 mx-4 sm:grid-cols-12">
					<div className="col-span-12 sm:col-span-3">
						<div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-primary">
							<h3 className="text-3xl font-semibold text-primary">{technologies?.title}</h3>
							...
							{technologies?.list?.length > 0 &&
								technologies.list.map((item, index) => (
									<div
										...
										key={index}>
										<div className="font-caveat font-medium text-2xl text-primary mb-1 sm:mb-0">{item?.title}</div>
			...
			<section className="container px-4 py-12 mx-auto">
				<div className="grid gap-4 mx-4 sm:grid-cols-12">
					<div className="col-span-12 sm:col-span-3">
						<div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-primary">
							<h3 className="text-3xl font-semibold text-primary">{workExperiences?.title}</h3>
							...
							{workExperiences?.list?.length > 0 &&
								workExperiences.list.map((item, index) => (
									<div
										...
										<h3 className="text-lg font-bold text-slate-900 uppercase italic">{item?.company}</h3>
										<p className="mt-3">{item?.description}</p>
									</div>
								))}
						</div>
			...
			<section className="container px-4 py-12 mx-auto">
				<div className="grid gap-4 mx-4 sm:grid-cols-12">
					<div className="col-span-12 sm:col-span-3">
						<div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-primary">
							<h3 className="text-3xl font-semibold text-primary">{projects?.title}</h3>
							<span className="text-sm font-bold text-justify uppercase text-gray-400">{projects?.description}</span>
						</div>
					</div>
